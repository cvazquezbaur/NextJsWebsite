...
export default async function OutdoorsPage() {
  ...
  try {
    media = await db
      .select()
      .from(mediaFiles)
      .where(eq(mediaFiles.category, "outdoors"))
